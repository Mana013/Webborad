    ...
    <?php 
        ...
        while($row = $result->fetch()){
            ...
            if(isset($_SESSION['id'])&& $_SESSION['role'] == 'a'){
                ...
                echo "<td class=col-1><a href='delete.php?del=$row[2]' name='del' onclick='return myConfirm()' onsubmit='return confirmDelete()'><button type='submit' class='btn btn-danger m-1'><i class='bi bi-trash3'></i></button></form></td></tr>";
            }
